  ...
  ngOnInit() {
    ...
    this.router.events.subscribe(event => {
      if (event instanceof NavigationEnd) {
        ...
        if (currentRoute.startsWith('/dashboarduser/videocall/') || currentRoute.startsWith('/dashboardemp/updateempprofile/') ||currentRoute.startsWith('/dashboardemp/set-question/') || currentRoute.startsWith('/dashboardemp/updatejob/') || currentRoute.startsWith('/employer/checkotpemployer/') || currentRoute.startsWith('/admin/notify/') || currentRoute.startsWith('/dashboardemp/videocall/') || currentRoute.startsWith('/dashboardemp/empmessage/') || currentRoute.startsWith('/employer/optverify/') || currentRoute.startsWith('/dashboarduser/updateprofile/')) {
